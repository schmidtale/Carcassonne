...
class TileStack(val startingTile: Tile = new Tile(name = "D", borders = Vector(road, town, road, pasture)).rotate(3),
  ...
  private val Tile_C = new Tile(name = "C", townConnection = true, borders = Vector(town, town, town, town), coatOfArms = true)
  ...
  private val Tile_F = new Tile(name = "F", townConnection = true, borders = Vector(pasture, town, pasture, town), coatOfArms = true)
  ...
  private val Tile_M = new Tile(name = "M", townConnection = true, borders = Vector(town, pasture, pasture, town), coatOfArms = true)
  private val Tile_N = new Tile(name = "N", townConnection = true, borders = Vector(town, pasture, pasture, town))
  private val Tile_O = new Tile(name = "O", townConnection = true, borders = Vector(town, road, road, town), coatOfArms = true)
  private val Tile_P = new Tile(name = "P", townConnection = true, borders = Vector(town, road, road, town))
  private val Tile_Q = new Tile(name = "Q", townConnection = true, borders = Vector(town, town, pasture, town), coatOfArms = true)
  private val Tile_R = new Tile(name = "R", townConnection = true, borders = Vector(town, town, pasture, town))
  private val Tile_S = new Tile(name = "S", townConnection = true, borders = Vector(town, town, road, town), coatOfArms = true)
